...
class CriteresType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('lieu', Type\ChoiceType::class, ["attr"=>['class' => 'choixLieu', "required" => false], 'choices' => ['Bureau' => 'bureau', 'Domicile' => 'domicile'],           
            'expanded' => true,
            'multiple' => false])
            ->add('annee_constr', Type\TextType::class, ["required" => false, "label" => "Quelle est l'année de construction de votre immeuble?"])
            ->add('plan_lieu', Type\TextType::class, ["required" => false, "label" => "Téléchargez le plan de votre immeuble."])
            ->add('photo_lieu', Type\TextType::class,["required" => false, "label" => "Téléchargez les photos de votre appartement."])
            ->add('orientation', Type\TextType::class, ["required" => false, "label" => "Veuillez sélectionner l'orientation de votre immeuble."])
