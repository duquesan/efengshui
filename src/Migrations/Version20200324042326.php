 ...
 */
final class Version20200324042326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE critere CHANGE user_id user_id INT DEFAULT NULL, CHANGE lieu lieu enum(\'bureau\', \'domicile\'), CHANGE plan_lieu plan_lieu VARCHAR(255) DEFAULT NULL, CHANGE photo_lieu photo_lieu VARCHAR(255) DEFAULT NULL, CHANGE orientation orientation VARCHAR(255) NOT NULL');
